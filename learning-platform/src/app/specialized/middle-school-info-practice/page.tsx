...
import MiddleSchoolInfoPractice from "@/components/MiddleSchoolInfoPractice";
import { getSessionUser } from "@/lib/auth-server";
import { isFirebaseAdminConfigured } from "@/lib/firebase-admin";

export default async function MiddleSchoolInfoPracticePage() {
  ...
  if (!user.approved) {
    return (
      <section className="access-state">
        ...
        <p>관리자 승인 후 중학교 정보 문제풀이 페이지를 이용할 수 있습니다.</p>
  ...
  return <MiddleSchoolInfoPractice />;
}
