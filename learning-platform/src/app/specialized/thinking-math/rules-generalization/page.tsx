...
import ThinkingMathRulesGeneralization from "@/components/ThinkingMathRulesGeneralization";
import { getSessionUser } from "@/lib/auth-server";
import { isFirebaseAdminConfigured } from "@/lib/firebase-admin";

export default async function RulesGeneralizationPage() {
  ...
  return <ThinkingMathRulesGeneralization />;
}
